...
public class RequirementModel extends AbstractListModel<Requirement> {
	 ...
	 * 
	 * @param id
	 *            The ID number of the requirement to be returned @return the
	 *            requirement for the id or null if the requirement is not found
	 */
	 ...
	 * 
	 * @param index
	 *            The index of the requirement to be returned @return the
	...
	/**
	 * Removes all requirements from this model NOTE: One cannot simply
	 * construct a new instance of the model, because other classes in this
	 * module have references to it. Hence, we manually remove each requirement
	 * from the model.
	 */
	 ...
	 * 
	 * @param requirement
	 *            the parent requirement to find children for. @return The list
	 *            of children.
	 */
	 ...
	 * 
	 * @param req
	 *            the given requirement @return the list model of
	 *            possiblechildren
	 */
	 ...
	 * 
	 * @param name
	 *            the iteration name @return the list of requirements
	 */
	 ...
	 * 
	 * @param displayIteration
	 *            the iteration to get requirements for @return the summed
	 *            estimates of the requirements.
	 */
	public int getRequirementEstimateForIteration(Iteration displayIteration) {
		int estimate = 0;
		List<Requirement> inIteration = getRequirementsForIteration(displayIteration
				.getName());
