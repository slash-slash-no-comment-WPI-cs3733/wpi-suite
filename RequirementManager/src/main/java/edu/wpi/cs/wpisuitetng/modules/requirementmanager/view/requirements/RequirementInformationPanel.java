...
public class RequirementInformationPanel extends JScrollPane implements
		...
		editParent.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (currentRequirement.getParentID() != -1) {
					viewEventController.editRequirement(currentRequirement
							.getParent());
				}
			}
		});
		...
		removeFromParent.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				UpdateRequirementController.getInstance().updateRequirement(
						currentRequirement);
				viewEventController
						.refreshEditRequirementPanel(currentRequirement);
	...
	private void repopulateIterationInformation() {
		...
		DefaultComboBoxModel<Iteration> aModel = new DefaultComboBoxModel<Iteration>(
				iterationArray);
	...
	private void refreshIteration() {
		Iteration cur = iterationModel.getIteration(currentRequirement
				.getIteration());
	 ...
	 * @param b
	 *            boolean @see
	 *            edu.wpi.cs.wpisuitetng.modules.requirementmanager.
	 *            view.requirements
	 *            .RequirementPanelListener#fireDeleted(boolean)
	 */
	@Override
	 ...
	 *            boolean @see
	 *            edu.wpi.cs.wpisuitetng.modules.requirementmanager.
	 *            view.requirements.RequirementPanelListener#fireValid(boolean)
	 */
	@Override
	 ...
	 *            edu.wpi.cs.wpisuitetng.modules.requirementmanager.
	 *            view.requirements
	 *            .RequirementPanelListener#fireChanges(boolean)
	 */
	@Override
	...
	private void fillFieldsForRequirement() {
		...
		storedIteration = iterationModel.getIteration(currentRequirement
				.getIteration());
		boxIteration.setSelectedItem(storedIteration);
	...
	public boolean validateFields(boolean warn) {
		...
		if (getBoxEstimate().getText().trim().length() <= 0) {
			...
			isEstimateValid = false;
				...
				&& !(getBoxIteration().getSelectedItem() == IterationModel
	...
	private boolean anythingChangedEditing() {
		...
		// Check if the user has changed the iteration number
		if (getBoxIteration().getSelectedItem() != null
				&& !(getBoxIteration().getSelectedItem().toString()
	 ...
	 * 
	 * @param e
	 *            KeyEvent @see java.awt.event.KeyListener#keyReleased(KeyEvent)
	 */
	@Override
	 ...
	 * 
	 * @param e
	 *            KeyEvent @see java.awt.event.KeyListener#keyPressed(KeyEvent)
	 */
	@Override
	 ...
	 * 
	 * @param e
	 *            KeyEvent @see java.awt.event.KeyListener#keyTyped(KeyEvent)
	 */
	@Override
	...
	/**
	 * @param storedIteration
	 *            the storedIteration to set
	 */
	...
	/**
	 * @param labelChildEstimate
	 *            the labelChildEstimate to set
	 */
	...
	/**
	 * @param labelTotalEstimate
	 *            the labelTotalEstimate to set
	 */
	...
	/**
	 * @param noParentInfoPanel
	 *            the noParentInfoPanel to set
	 */
	...
	/**
	 * @param dropdownPriority
	 *            the dropdownPriority to set
	 */
	...
	/**
	 * @param lastValidStatus
	 *            the lastValidStatus to set
	 */
	...
	/**
	 * @param fillingFieldsForRequirement
	 *            the fillingFieldsForRequirement to set
	 */
	...
	/**
	 * @param boxChildEstimate
	 *            the boxChildEstimate to set
	 */
	...
	/**
	 * @param boxTotalEstimate
	 *            the boxTotalEstimate to set
	 */
